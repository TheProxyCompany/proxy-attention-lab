...
# def test_max_score_over_history_in_one_block(head_dim, dtype) -> None:
...
#     k_cache_shape = (1, cfg_num_kv_heads, cfg_tokens_per_page, cfg_head_dim)
...
#     py_k_cache_pool[0, 0, 1, :] = mx.array([2.0, 2.0, 2.0, 2.0], dtype=dtype)  # Position 1
#     py_k_cache_pool[0, 0, 2, :] = mx.array([0.5, 0.5, 0.5, 0.5], dtype=dtype)  # Position 2
...
#     py_v_cache_pool[0, 0, 1, :] = mx.array([20.0, 21.0, 22.0, 23.0], dtype=dtype)  # Position 1
#     py_v_cache_pool[0, 0, 2, :] = mx.array([30.0, 31.0, 32.0, 33.0], dtype=dtype)  # Position 2
...
#         k_vec_py = py_k_cache_pool[0, 0, hist_idx_calc, :].astype(mx.float32)
...
#             v_hist = py_v_cache_pool[0, 0, i, :].astype(mx.float32)
...
# @pytest.mark.parametrize("head_dim", [32, 64, 128, 256])
# @pytest.mark.parametrize("dtype", [mx.float16, mx.bfloat16])
# def test_max_score_over_multi_block_history(head_dim, dtype) -> None:
...
#     py_k_cache_pool[1, 0, 1, :] = mx.array([1.5, 1.5, 1.5, 1.5], dtype=dtype)  # Position 4
...
#     py_v_cache_pool[0, 0, 1, :] = mx.array([50.0, 60.0, 70.0, 80.0], dtype=dtype)  # Position 1
#     py_v_cache_pool[0, 0, 2, :] = mx.array([5.0, 6.0, 7.0, 8.0], dtype=dtype)  # Position 2
...
#     py_v_cache_pool[1, 0, 1, :] = mx.array([15.0, 25.0, 35.0, 45.0], dtype=dtype)  # Position 4
...
#         k_vec = py_k_cache_pool[physical_page_id, 0, token_slot_in_page, :].astype(mx.float32)
#         v_vec = py_v_cache_pool[physical_page_id, 0, token_slot_in_page, :].astype(mx.float32)
...
# @pytest.mark.parametrize("head_dim", [32, 64, 128, 256])
# @pytest.mark.parametrize("dtype", [mx.float16, mx.bfloat16])
# def test_zero_history_returns_zero_score(head_dim, dtype) -> None:
...
#     py_v_cache_pool[0, 0, 0, :] = mx.array([10.0, 20.0, 30.0, 40.0], dtype=dtype)  # Position 0
#     py_v_cache_pool[0, 0, 1, :] = mx.array([50.0, 60.0, 70.0, 80.0], dtype=dtype)  # Position 1 (highest score)
#     py_v_cache_pool[0, 0, 2, :] = mx.array([5.0, 6.0, 7.0, 8.0], dtype=dtype)  # Position 2
...
# @pytest.mark.parametrize("head_dim", [32, 64, 128, 256])
# @pytest.mark.parametrize("dtype", [mx.float16, mx.bfloat16])
# def test_history_limited_by_sequence_length(head_dim, dtype) -> None:
...
#     py_k_cache_pool[0, 0, 1, :] = mx.array([3.0, 3.0, 3.0, 3.0], dtype=dtype)

#     # Position 2 - Score will be 4.0 after scale
#     py_k_cache_pool[0, 0, 2, :] = mx.array([2.0, 2.0, 2.0, 2.0], dtype=dtype)
...
#     py_v_cache_pool[0, 0, 3, :] = mx.array([100.0, 200.0, 300.0, 400.0], dtype=dtype)  # Position 3
#     py_v_cache_pool[0, 0, 4, :] = mx.array([500.0, 600.0, 700.0, 800.0], dtype=dtype)  # Position 4
...
#     v_vec1 = py_v_cache_pool[0, 0, 1, :].astype(mx.float32)
#     v_vec2 = py_v_cache_pool[0, 0, 2, :].astype(mx.float32)
...
# @pytest.mark.parametrize("head_dim", [32, 64, 128, 256])
# @pytest.mark.parametrize("dtype", [mx.float16, mx.bfloat16])
# def test_history_scan_stops_at_page_table_limit(head_dim, dtype) -> None:
...
#     py_k_cache_pool[1, 0, 1, :] = mx.array([3.0, 3.0, 3.0, 3.0], dtype=dtype)
...
#     py_v_cache_pool[0, 0, 1, :] = mx.array([50.0, 60.0, 70.0, 80.0], dtype=dtype)  # Position 1 (page 0, slot 1)
#     py_v_cache_pool[1, 0, 0, :] = mx.array(
#         [500.0, 600.0, 700.0, 800.0], dtype=dtype
#     )  # Position 2 (page 1, slot 0) - highest K score
#     py_v_cache_pool[1, 0, 1, :] = mx.array([100.0, 200.0, 300.0, 400.0], dtype=dtype)  # Position 3 (page 1, slot 1)
